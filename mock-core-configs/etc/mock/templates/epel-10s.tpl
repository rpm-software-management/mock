...
metalink=https://mirrors.fedoraproject.org/metalink?repo=epel-{{ releasever_major }}s&arch=$basearch
...
metalink=https://mirrors.fedoraproject.org/metalink?repo=epel-testing-{{ releasever_major }}s&arch=$basearch
gpgkey=file:///usr/share/distribution-gpg-keys/epel/RPM-GPG-KEY-EPEL-{{ releasever_major }}
gpgcheck=1
countme=1
enabled=0
...
baseurl=https://kojipkgs.fedoraproject.org/repos/epel{{ releasever_major }}s/latest/$basearch/
cost=2000
enabled=0
