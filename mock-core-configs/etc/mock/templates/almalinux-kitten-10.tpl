...
mirrorlist=https://kitten.mirrors.almalinux.org/mirrorlist/$releasever-kitten/extras
# baseurl=https://kitten.repo.almalinux.org/$releasever-kitten/extras/$basearch/os/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/alma/RPM-GPG-KEY-AlmaLinux-10
...
mirrorlist=https://kitten.mirrors.almalinux.org/mirrorlist/$releasever-kitten/extras-debuginfo
# baseurl=https://kitten.repo.almalinux.org/$releasever-kitten/extras/debug/$basearch/
enabled=0
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/alma/RPM-GPG-KEY-AlmaLinux-10
...
mirrorlist=https://kitten.mirrors.almalinux.org/mirrorlist/$releasever-kitten/extras-source
# baseurl=https://kitten.repo.almalinux.org/$releasever-kitten/extras/Source/
enabled=0
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/alma/RPM-GPG-KEY-AlmaLinux-10
