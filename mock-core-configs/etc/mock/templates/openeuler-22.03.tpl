...
[source]
name=source
metalink=https://mirrors.openeuler.org/metalink?path=openeuler/openEuler-22.03-LTS-SP4/source/repodata/repomd.xml
enabled=0
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
...
[update-source]
name=update-source
metalink=https://mirrors.openeuler.org/metalink?path=openeuler/openEuler-22.03-LTS-SP4/update/source/repodata/repomd.xml
enabled=0
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
"""
