...
%changelog
* Thu Mar 16 2023 Pavel Raiskup <praiskup@redhat.com> 36.17-1
...
- openEuler 22.03-SP1 released, so we switch to latest repo url (pkwarcraft@gmail.com)

* Thu Jan 05 2023 Pavel Raiskup <praiskup@redhat.com> 36.14-1
...
- configs: update the %%description

* Thu Mar 03 2022 Pavel Raiskup <praiskup@redhat.com> 36.7-1
...
- Fedora 36 branching
- depend on distribution-gpg-keys 1.63
